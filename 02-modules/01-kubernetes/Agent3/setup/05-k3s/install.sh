...
echo "  ============================================";
echo "    PUBLIC_IP:           $AGENT3_PUBLIC_IP"
echo "    DOMAIN_NAME:         $AGENT3_DOMAIN_NAME"
echo "    AGENT1_ZEROTIER_IP:  $AGENT3_ZEROTIER_IP"
...
INSTALL_K3S_EXEC="agent --node-ip=$AGENT3_ZEROTIER_IP --node-external-ip=$AGENT3_PUBLIC_IP --docker" \
