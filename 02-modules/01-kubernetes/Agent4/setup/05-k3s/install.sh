...
echo "  ============================================";
echo "    PUBLIC_IP:           $AGENT4_PUBLIC_IP"
echo "    DOMAIN_NAME:         $AGENT4_DOMAIN_NAME"
echo "    AGENT1_ZEROTIER_IP:  $AGENT4_ZEROTIER_IP"
...
INSTALL_K3S_EXEC="agent --node-ip=$AGENT4_ZEROTIER_IP --node-external-ip=$AGENT4_PUBLIC_IP --docker" \
