...
echo "  ============================================";
echo "    PUBLIC_IP:           $AGENT2_PUBLIC_IP"
echo "    DOMAIN_NAME:         $AGENT2_DOMAIN_NAME"
echo "    AGENT1_ZEROTIER_IP:  $AGENT2_ZEROTIER_IP"
...
INSTALL_K3S_EXEC="agent --node-ip=$AGENT2_ZEROTIER_IP --node-external-ip=$AGENT2_PUBLIC_IP --docker" \
